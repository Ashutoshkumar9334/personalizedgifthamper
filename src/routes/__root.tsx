    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This page has been unwrapped and moved elsewhere.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "A_S Hamper — Personalised Gift Hampers" },
      {
        name: "description",
        content:
          "Hand-packed personalised gift hampers for birthdays, weddings, festivals and corporate gifting.",
      },
      { name: "author", content: "A_S Hamper" },
      { property: "og:title", content: "A_S Hamper — Personalised Gift Hampers" },
      {
        property: "og:description",
        content: "Build your own hamper, add a photo and message, and choose the delivery day.",
      },
